    ...
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color }) => {
          ...
          else if (route.name === "PerfilAba")
            iconName = focused ? "person" : "person-outline"; // Ícone do Perfil
...
function NutriTabs({ route }: any) {
  // A Nutri também precisa passar o próprio ID para a tela de Perfil
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        {/* As telas abaixo ficam fora das abas (cobrem a tela toda) */}
        <Stack.Screen name="NutriCriarPlano" component={NutriCriarPlano} />
        <Stack.Screen name="Agendamento" component={Agendamento} />
        <Stack.Screen name="Historico" component={Historico} />
        {/* A tela "Perfil" ainda fica aqui caso precise ser aberta cobrindo a tela toda de algum outro lugar */}
        <Stack.Screen name="Perfil" component={Perfil} />
        <Stack.Screen
          name="NutriDesempenhoPaciente"
          component={NutriDesempenhoPaciente}
        />
        <Stack.Screen
          name="RegistroDesempenho"
          component={RegistroDesempenho}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
